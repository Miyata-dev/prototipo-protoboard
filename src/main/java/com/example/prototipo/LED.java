...
public class LED extends Group {
    ...
    private String ID; //esta ID se setea cuando ya se tenga 2 CustomCircles.
    ...
    public LED(boolean state, CustomShape customShape, Basurero basurero, AnchorPane root) {
        ...
        this.setOnMouseClicked(e -> {
            ...
            this.ID = Utils.mergeIDs(
                new String[] {
                    customShape.getLeg1().getID().getGeneratedID(),
                    customShape.getLeg2().getID().getGeneratedID()
                }
            );
